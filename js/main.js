...
make_roaming_menu = function(mode) {
  if (mode === 'xs') {
    ...
    $('#roaming-pager').detach().appendTo('#leftrow');  // Changed from right row
    $('#roaming-share').detach().appendTo('#leftrow'); // Changed from right row
    $('#roaming-attribution').detach().appendTo('#leftrow'); // Changed from right row
    $('#roaming-pager-newer').detach().appendTo('#full-pager');
    return $('#roaming-pager-older').detach().appendTo('#full-pager');
  }
};
